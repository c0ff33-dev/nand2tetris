...
cd ~/src/nand2tetris/interpreter && ~/src/nand2tetris/.venv/bin/python emulator/hack/hack.pygame
cd ~/src/nand2tetris/interpreter && ~/src/nand2tetris/.venv/bin/python emulator/hack/build_package.py  # stages build/hack/ and writes build/HACK.zip
