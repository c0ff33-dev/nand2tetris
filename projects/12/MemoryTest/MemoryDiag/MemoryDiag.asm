...
// push constant 17000
@17000 // push constant 17000 // function Main.main 5 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// push constant 7000
@7000 // push constant 7000 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
(Main.checkRange) // function Main.checkRange 1
@SP
A=M
M=0
D=A+1
...
// push argument 0
@ARG // push argument 0 // function Main.checkRange 1
A=M
D=M
@SP
AM=M+1
...
AM=M-1 // SP--, A -> val
D=M // d = val
@Main.checkRange$IF_TRUE0
D;JNE // jump if not zero

// goto IF_FALSE0
@Main.checkRange$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Main.checkRange$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Main.checkRange$IF_FALSE0) // label IF_FALSE0
...
(Main.checkOverlap) // function Main.checkOverlap 2
@SP
A=M
M=0
A=A+1
...
// push argument 0
@ARG // push argument 0 // function Main.checkOverlap 2
A=M
D=M
@SP
AM=M+1
...
AM=M-1 // SP--, A -> val
D=M // d = val
@Main.checkOverlap$IF_TRUE0
D;JNE // jump if not zero

// goto IF_FALSE0
@Main.checkOverlap$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Main.checkOverlap$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Main.checkOverlap$IF_FALSE0) // label IF_FALSE0
...
// push static 0
@16 // push static 0 (static ../projects/12/MemoryTest/MemoryDiag/Math.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@17 // push static 1 (static ../projects/12/MemoryTest/MemoryDiag/Math.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@18 // push static 0 (static ../projects/12/MemoryTest/MemoryDiag/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 5
@24 // push static 5 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 6
@25 // push static 6 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@21 // push static 2 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 4
@23 // push static 4 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@19 // push static 0 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 3
@22 // push static 3 // function Output.printInt 0 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 3
@22 // push static 3 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 // function Output.println 0 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@21 // push static 2 // function Output.backSpace 0 (static ../projects/12/MemoryTest/MemoryDiag/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@26 // push static 0 (static ../projects/12/MemoryTest/MemoryDiag/Screen.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@27 // push static 1 (static ../projects/12/MemoryTest/MemoryDiag/Screen.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@28 // push static 2 // function Screen._updateLocation 0 (static ../projects/12/MemoryTest/MemoryDiag/Screen.vm)
D=M
@SP
AM=M+1
A=A-1
