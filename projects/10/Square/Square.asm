...
// call SquareGame.new 0 // function Main.main 1
@RET_CALL_17
D=A
@CALL_SquareGame.new_0
0;JMP
(RET_CALL_17)
// pop local 0
@SP // pop local 0
...
// push constant 0
@SP // push constant 0 // function Main.more 4
AM=M+1 // SP++
A=A-1 // A -> slot
M=0 // direct assign
// if-goto IF_TRUE0
...
// goto IF_FALSE0
@Main.more$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Main.more$IF_TRUE0) // label IF_TRUE0
...
// goto IF_END0
@Main.more$IF_END0 // goto IF_END0
0;JMP // unconditional jump

// label IF_FALSE0
(Main.more$IF_FALSE0) // label IF_FALSE0
...
// label IF_END0
(Main.more$IF_END0) // label IF_END0
...
// push constant 3
@3 // push constant 3 // function Square.new 0 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// push constant 254
@254 // push constant 254 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// goto IF_FALSE0
@Square.incSize$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Square.incSize$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Square.incSize$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE0
@Square.decSize$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Square.decSize$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Square.decSize$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE0
@Square.moveUp$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Square.moveUp$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Square.moveUp$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE0
@Square.moveDown$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Square.moveDown$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Square.moveDown$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE0
@Square.moveLeft$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Square.moveLeft$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Square.moveLeft$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE0
@Square.moveRight$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(Square.moveRight$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(Square.moveRight$IF_FALSE0) // label IF_FALSE0
...
// push static 0
@16 // push static 0 (static ../projects/10/Square/Math.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@17 // push static 1 (static ../projects/10/Square/Math.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@18 // push static 0 (static ../projects/10/Square/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 5
@24 // push static 5 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 6
@25 // push static 6 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@21 // push static 2 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 4
@23 // push static 4 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@19 // push static 0 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 3
@22 // push static 3 // function Output.printInt 0 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 3
@22 // push static 3 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 // function Output.println 0 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@21 // push static 2 // function Output.backSpace 0 (static ../projects/10/Square/Output.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@26 // push static 0 (static ../projects/10/Square/Screen.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@27 // push static 1 (static ../projects/10/Square/Screen.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@28 // push static 2 // function Screen.updateLocation 0 (static ../projects/10/Square/Screen.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push constant 2
@2 // push constant 2 // function SquareGame.new 0 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// goto IF_FALSE0
@SquareGame.moveSquare$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(SquareGame.moveSquare$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(SquareGame.moveSquare$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE1
@SquareGame.moveSquare$IF_FALSE1 // goto IF_FALSE1
0;JMP // unconditional jump

// label IF_TRUE1
(SquareGame.moveSquare$IF_TRUE1) // label IF_TRUE1
...
// label IF_FALSE1
(SquareGame.moveSquare$IF_FALSE1) // label IF_FALSE1
...
// goto IF_FALSE2
@SquareGame.moveSquare$IF_FALSE2 // goto IF_FALSE2
0;JMP // unconditional jump

// label IF_TRUE2
(SquareGame.moveSquare$IF_TRUE2) // label IF_TRUE2
...
// label IF_FALSE2
(SquareGame.moveSquare$IF_FALSE2) // label IF_FALSE2
...
// goto IF_FALSE3
@SquareGame.moveSquare$IF_FALSE3 // goto IF_FALSE3
0;JMP // unconditional jump

// label IF_TRUE3
(SquareGame.moveSquare$IF_TRUE3) // label IF_TRUE3
...
// label IF_FALSE3
(SquareGame.moveSquare$IF_FALSE3) // label IF_FALSE3
...
// label WHILE_EXP0
(SquareGame.run$WHILE_EXP0) // label WHILE_EXP0
...
// label WHILE_EXP1
(SquareGame.run$WHILE_EXP1) // label WHILE_EXP1
...
// goto WHILE_EXP1
@SquareGame.run$WHILE_EXP1 // goto WHILE_EXP1
0;JMP // unconditional jump

// label WHILE_END1
(SquareGame.run$WHILE_END1) // label WHILE_END1
...
// goto IF_FALSE0
@SquareGame.run$IF_FALSE0 // goto IF_FALSE0
0;JMP // unconditional jump

// label IF_TRUE0
(SquareGame.run$IF_TRUE0) // label IF_TRUE0
...
// label IF_FALSE0
(SquareGame.run$IF_FALSE0) // label IF_FALSE0
...
// goto IF_FALSE1
@SquareGame.run$IF_FALSE1 // goto IF_FALSE1
0;JMP // unconditional jump

// label IF_TRUE1
(SquareGame.run$IF_TRUE1) // label IF_TRUE1
...
// label IF_FALSE1
(SquareGame.run$IF_FALSE1) // label IF_FALSE1
...
// goto IF_FALSE2
@SquareGame.run$IF_FALSE2 // goto IF_FALSE2
0;JMP // unconditional jump

// label IF_TRUE2
(SquareGame.run$IF_TRUE2) // label IF_TRUE2
...
// label IF_FALSE2
(SquareGame.run$IF_FALSE2) // label IF_FALSE2
...
// push constant 131
@131 // push constant 131 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// goto IF_FALSE3
@SquareGame.run$IF_FALSE3 // goto IF_FALSE3
0;JMP // unconditional jump

// label IF_TRUE3
(SquareGame.run$IF_TRUE3) // label IF_TRUE3
...
// label IF_FALSE3
(SquareGame.run$IF_FALSE3) // label IF_FALSE3
...
// push constant 133
@133 // push constant 133 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// goto IF_FALSE4
@SquareGame.run$IF_FALSE4 // goto IF_FALSE4
0;JMP // unconditional jump

// label IF_TRUE4
(SquareGame.run$IF_TRUE4) // label IF_TRUE4
...
// label IF_FALSE4
(SquareGame.run$IF_FALSE4) // label IF_FALSE4
...
// goto IF_FALSE5
@SquareGame.run$IF_FALSE5 // goto IF_FALSE5
0;JMP // unconditional jump

// label IF_TRUE5
(SquareGame.run$IF_TRUE5) // label IF_TRUE5
...
// label IF_FALSE5
(SquareGame.run$IF_FALSE5) // label IF_FALSE5
...
// goto IF_FALSE6
@SquareGame.run$IF_FALSE6 // goto IF_FALSE6
0;JMP // unconditional jump

// label IF_TRUE6
(SquareGame.run$IF_TRUE6) // label IF_TRUE6
...
// label IF_FALSE6
(SquareGame.run$IF_FALSE6) // label IF_FALSE6

// label WHILE_EXP2
(SquareGame.run$WHILE_EXP2) // label WHILE_EXP2
...
// goto WHILE_EXP2
@SquareGame.run$WHILE_EXP2 // goto WHILE_EXP2
0;JMP // unconditional jump

// label WHILE_END2
(SquareGame.run$WHILE_END2) // label WHILE_END2

// goto WHILE_EXP0
@SquareGame.run$WHILE_EXP0 // goto WHILE_EXP0
0;JMP // unconditional jump

// label WHILE_END0
(SquareGame.run$WHILE_END0) // label WHILE_END0
