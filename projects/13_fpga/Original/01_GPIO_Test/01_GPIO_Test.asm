...
M=0 // direct assign
// push static 0
@16 // push static 0 (static ../projects/13_fpga/Original/01_GPIO_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 1
@17 // push static 1 (static ../projects/13_fpga/Original/01_GPIO_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=D
// push static 2
@18 // push static 2 (static ../projects/13_fpga/Original/01_GPIO_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
