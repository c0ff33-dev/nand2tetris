...
// call UART.init 0 // function Sys.init 0
@RET_CALL_1
D=A
@CALL_UART.init_0
0;JMP
...
// push static 1
@17 // push static 1 (static ../projects/13_fpga/Original/02_UART_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 0
@16 // push static 0 (static ../projects/13_fpga/Original/02_UART_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
