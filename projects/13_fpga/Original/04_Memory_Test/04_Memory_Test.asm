...
// push constant 4107
@4107 // push constant 4107 // function Main.main 4 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// push constant 4108
@4108 // push constant 4108 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// push constant 4109
@4109 // push constant 4109 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// push constant 4110
@4110 // push constant 4110 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
// push constant 4111
@4111 // push constant 4111 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
M=0 // direct assign
// push static 0
@16 // push static 0 (static ../projects/13_fpga/Original/04_Memory_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 1
@17 // push static 1 (static ../projects/13_fpga/Original/04_Memory_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=D
// push static 2
@18 // push static 2 (static ../projects/13_fpga/Original/04_Memory_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 (static ../projects/13_fpga/Original/04_Memory_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@19 // push static 0 (static ../projects/13_fpga/Original/04_Memory_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@21 // push static 2 (static ../projects/13_fpga/Original/04_Memory_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@23 // push static 1 (static ../projects/13_fpga/Original/04_Memory_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 0
@22 // push static 0 (static ../projects/13_fpga/Original/04_Memory_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
