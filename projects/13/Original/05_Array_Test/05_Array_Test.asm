...
M=0 // direct assign
// push static 0
@16 // push static 0 (static ../projects/13/Original/05_Array_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 1
@17 // push static 1 (static ../projects/13/Original/05_Array_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=D
// push static 2
@18 // push static 2 (static ../projects/13/Original/05_Array_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 (static ../projects/13/Original/05_Array_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@19 // push static 0 (static ../projects/13/Original/05_Array_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@21 // push static 2 (static ../projects/13/Original/05_Array_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@23 // push static 1 (static ../projects/13/Original/05_Array_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 0
@22 // push static 0 (static ../projects/13/Original/05_Array_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
