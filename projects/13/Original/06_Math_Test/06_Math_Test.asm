...
// push constant 4107
@4107 // push constant 4107 // function Main.main 1 (constant)
D=A // d = constant
@SP // &esp
AM=M+1 // SP++
A=A-1 // A -> slot
...
M=0 // direct assign
// push static 0
@16 // push static 0 (static ../projects/13/Original/06_Math_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 1
@17 // push static 1 (static ../projects/13/Original/06_Math_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=D
// push static 2
@18 // push static 2 (static ../projects/13/Original/06_Math_Test/GPIO.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@19 // push static 0 (static ../projects/13/Original/06_Math_Test/Math.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@20 // push static 1 (static ../projects/13/Original/06_Math_Test/Math.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@22 // push static 1 (static ../projects/13/Original/06_Math_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 0
@21 // push static 0 (static ../projects/13/Original/06_Math_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 2
@23 // push static 2 (static ../projects/13/Original/06_Math_Test/Memory.vm)
D=M
@SP
AM=M+1
A=A-1
...
// push static 1
@25 // push static 1 (static ../projects/13/Original/06_Math_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
...
M=0 // direct assign
// push static 0
@24 // push static 0 (static ../projects/13/Original/06_Math_Test/UART.vm)
D=M
@SP
AM=M+1
A=A-1
