...
if __name__ == '__main__':
    ...
    jack_filepaths = [
        ...
        r"../projects/12/MathTest/Main.jack",
        r"../projects/12/MathTest/Math.jack",
    ]
    ...
    jack_matches = {  
        ...
        # r'../projects/12/MathTest/Main.vm': xxx, # TODO: NYI
        # r'../projects/12/MathTest/Math.vm': xxx, # TODO: NYI
    }
    ...
    binary_asm_filepaths = [
        ...
        r"../projects/12/MathTest/MathTest.asm",
    ]
    ...
    if debug:
        ...
        vm_dirpaths = []
        vm_asm_filepaths = []
        binary_asm_filepaths = [r'../../nand2tetris-fpga/06_IO_Devices/03_SPI/cat.asm']
        hw_tst_files = []
        cpu_tst_files = []
        vm_tst_files = []
